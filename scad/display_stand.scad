...
part = 2; // [1:"cradle_single - 1 Slide-in Cradle Foot", 2:"cradle_pair - Pair of Slide-in Cradle Feet (L+R)", 3:"cradle_set4 - Set of 4 Cradle Feet", 4:"screw_single - 1 Bolt-on Rear Kickstand Leg", 5:"screw_pair - Pair of Bolt-on Kickstand Legs", 6:"preview - Assembled 3D Preview with Digit Panel", 7:"bottom_view - Underside View with 2x 13mm Pad Recesses"]
...
foot_w          = 26.0; // Width of each stand foot along X (mm)
...
} else if (part == 6 || part == "preview" || part == "assembly") {
    display_stand_assembled_preview();
} else if (part == 7 || part == "bottom_view") {
    rotate([180, 0, 0])
        color("#0284c7")
            cradle_stand_foot();
}
