...
if (show_frontplate_black) color("DimGray", alpha_frontplate_black) frontplate_black();
if (show_frontplate_white) translate([0, 0, 20]) color("White", alpha_frontplate_white) frontplate_white();
if (show_backplate) color("SlateGray", alpha_backplate) backplate();
