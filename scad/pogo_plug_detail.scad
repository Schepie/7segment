...
// -------------------------------------------------------------
module pogo_connector_detailed(is_male = true) {
...
// -------------------------------------------------------------
module m2_fastener() {
    color("#94a3b8") { // Stainless steel metallic finish
        // Pan head
...
// -------------------------------------------------------------
module housing_wall_section(cut_half = false) {
    color("#334155") { // Dark Slate housing plastic
        difference() {
